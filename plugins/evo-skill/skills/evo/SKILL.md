---
name: evo
description: "技能自我进化 - 检测流程问题信号，生成分析报告，引导独立 session 处理改进"
---
...
将 `MONITOR.md` 的内容添加到项目的 `CLAUDE.md` 中，即可启用自动信号检测。

## 相关资源

- 设计文档: `docs/plans/2026-01-26-evo-skill-design.md`
- 监控指令: `skills/evo/MONITOR.md`